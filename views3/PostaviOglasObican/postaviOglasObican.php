...
<body style="background-color: lightgray;">
    <form name="postavi" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=user&action=adAd">
                ...
                <div class='col-sm-10 drugi_red'>
                    ...
                    <table>
                        ...
                        <tr id="aparat">
                            <td>
                                <a href="">
                                    <img src="./views/PostaviOglasObican/slike/upldimage.PNG" alt="Slika">
                                </a>
