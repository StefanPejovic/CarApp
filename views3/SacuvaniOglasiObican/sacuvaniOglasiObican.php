...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='./views/SacuvaniOglasiObican/fajlovi/bootstrap.min.css'>
    <link rel='stylesheet' type='text/css' href='./views/SacuvaniOglasiObican/sacuvaniOglasiObican.css'>

    <script src='./views/SacuvaniOglasiObican/fajlovi/bootstrap.min.js'></script>
                  ...
                  <div class='col-sm-12'>
                      <nav class='navbar navbar-expand-sm lightgraybg'>
                          <a class='navbar-brand' href='#'>
                              <img src='./views/SacuvaniOglasiObican/slike/logo.png' id="logo">
                          </a>
    ...
    <div id="postaviOglas">
                          ...
                          <table>
                              <tr>
                                  <td>
                                      <a href="">
                                          <img src="./views/SacuvaniOglasiObican/slike/ikon.PNG" alt="">
                                      </a>
                                  </td>
                              ...
                              <tr>
                                  <td id="td4" colspan="2">
                                      <a href="?controller=user&action=index"><img src="./views/SacuvaniOglasiObican/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                                  </td>
                              </tr>
                          </table>    
                      </nav>
...
<tr>
<td id="td1">
<img src="./views/SacuvaniOglasiObican/slike/Logo.png" style="height: 180px; width: 290px;" alt="slika">
</td>
<td id="td2">
...
<li>
     <form name="unsaveform" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=user&action=unsaveAd">
         <input type="hidden" name="idOglasaZaIzbacivanje" value="<?php echo $oglas->idO; ?>"/>      
    <input type="submit" value="Izbaci" name="submit_izbaci" style=" background-color: #00ced1; color: white; height: 50px; width: 170px" id="sacuvaj'.$oglas->idO.'"> </form></li><br/>
