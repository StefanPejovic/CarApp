...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='./views/GlavnaGost/fajlovi/bootstrap.min.css'>
    <link rel='stylesheet' type='text/css' href='./views/GlavnaGost/glavnaGost.css'>
...
<body style="background-color: lightgray;">
  <div class='container+fluid'>
     <form name="pretraga" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=guest&action=searchAd">
            <div class='row prvi_red'>
                <div class='col-sm-12'>
                    <nav class='navbar navbar-expand-sm lightgraybg'>
                        ...
                        <div id="odjaviSe">
                            <a href="?controller=guest&action=loginShow" style="color:white; text-decoration: none"><h4>Prijavi se</h4></a>
                        </div>
                        ...
                        <table id="prva_tabela">
                            <tr>
                                ...
                                <td><input type="text" placeholder="Gost" disabled></td>
                            </tr>
                            <tr>
                                <td id="td4" colspan="2">
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    <button name="button_trazi" type="submit" style="text-align: center; height: 70px; width: 170px" class="button_trazi">
                                        <a href="?controller=guset&action=searchAd" style="text-decoration: none"><h3>Trazi</h3></a>
                                    </button>
                                </td>
                            </tr>
                        </table>
