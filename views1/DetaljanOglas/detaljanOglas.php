...
<head>
    ...
    <script src='./views/DetaljanOglas/fajlovi/bootstrap.min.js'></script>
                    ...
                    <div class="row blank">
                        <table id="drugatb">
                            ...
                            <tr>
                                <td>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </td>
                                <td >
                                    <form name="pretraga" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=guest&action=postaviKomPre">
