...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='./views/SacuvaniOglasiVip/fajlovi/bootstrap.min.css'>
    <link rel='stylesheet' type='text/css' href='./views/SacuvaniOglasiVip/sacuvaniOglasiVip.css'>

    <script src='./views/SacuvaniOglasiVip/fajlovi/bootstrap.min.js'></script>
                  ...
                  <div class='col-sm-12'>
                      <nav class='navbar navbar-expand-sm lightgraybg'>
                          <a class='navbar-brand' href='#'>
                              <img src='./views/SacuvaniOglasiVip/slike/logo.png' id="logo">
                          </a>
    ...
    <div id="postaviOglas">
                          ...
                          <table>
                              <tr>
                                  <td>
                                      <a href="">
                                          <img src="./views/SacuvaniOglasiVip/slike/ikon.PNG" alt="">
                                      </a>
                                  </td>
                              ...
                              <tr>
                                  <td id="td4" colspan="2">
                                      <a href="?controller=vip&action=index"><img src="./views/SacuvaniOglasiVip/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                                  </td>
                              </tr>
                          </table>    
                      </nav>
...
<tr>
<td id="td1">
<img src="./views/SacuvaniOglasiVip/slike/Logo.png" style="height: 180px; width: 290px;" alt="slika">
</td>
<td id="td2">
...
<li>
     <form name="unsaveform" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=vip&action=unsaveAd">
