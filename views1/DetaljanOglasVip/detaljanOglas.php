...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='./views/DetaljanOglasVip/fajlovi/bootstrap.min.css'>
    <link rel='stylesheet' type='text/css' href='./views/DetaljanOglasVip/detaljanOglas.css'>

    <script src='./views/DetaljanOglasVip/fajlovi/bootstrap.min.js'></script>
                ...
                <div class='col-sm-12'>
                    <nav class='navbar navbar-expand-sm lightgraybg'>
                        <a class='navbar-brand' href='#'>
                            <img src='./views/DetaljanOglasVip/slike/logo.png' id="logo">
                        </a>
                        ...
                        <table id="prva_tabela">
                            <tr>
                                <td><img src="./views/DetaljanOglasVip/slike/ikon.PNG" alt=""></td>
                                <td><input type="text" value="<?php echo $_SESSION['user']->username ?>"></td>
                            </tr>
                            <tr>
                                <td id="td4" colspan="2">
                                    <a href="?controller=vip&action=index"><img src="./views/DetaljanOglasVip/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                                </td>
                            </tr>
                        </table>    
                    </nav>
                ...
                <div class='col-sm-10 drugi_red'>
                    <div class="row blank">
                        <table id="drugatb">
                            ...
                            <tr>                                    
                                <td id="td1">
                                    <img src="./views/DetaljanOglasVip/slike/kuga.PNG" style="height: 180px; width: 290px;" alt="slika">
                                </td>
                                <td id="td2">
                            ...
                            <tr>
                                <td>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </td>
                                <td >
                                    <form name="pretraga" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=vip&action=postaviKomPre">
