...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='./views/RecenzijeVip/fajlovi/bootstrap.min.css'>
    <link rel='stylesheet' type='text/css' href='./views/RecenzijeVip/recenzija.css'>

    <script src='./views/RecenzijeVip/fajlovi/bootstrap.min.js'></script>

</head>
<body style="background-color: lightgray;">
    <form name="pretraga" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=vip&action=postaviKom">
                ...
                <div class='col-sm-12'>
                    <nav class='navbar navbar-expand-sm lightgraybg'>
                        <a class='navbar-brand' href='#'>
                            <img src='./views/RecenzijeVip/slike/logo.png' id="logo">
                        </a>
                        ...
                        <table id="prva_tabela">
                            <tr>
                                <td><img src="./views/RecenzijeVip/slike/ikon.PNG" alt=""></td>
                                <td><input type="text" value="<?php echo $_SESSION['user']->username?>"></td>
                            </tr> 
                            <tr>
                                <td id="td4" colspan="2">
                                    <a href="?controller=vip&action=index"><img src="./views/Recenzije/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                                </td>
                            </tr>
                        </table>    
                    </nav>
                    ...
                    <h2>&nbsp &nbsp Rezultati Pretrage</h2>
                        ...
                        <div class="unutra">
                            <table id="drugatb">
                                ...
                                <tr>                                    
                                    <td id="td1">
                                        <img src="./views/RecenzijeVip/slike/kuga.PNG" style="height: 180px; width: 290px;" alt="slika">
                                    </td>
                                    <td id="td2">
