...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='./views/PostaviOglasObican/fajlovi/bootstrap.min.css'>
    <link rel='stylesheet' type='text/css' href='./views/PostaviOglasObican/postaviOglasObican.css'>

    <script src='./views/PostaviOglasObican/fajlovi/bootstrap.min.js'></script>

</head>
<body style="background-color: lightgray;">
    <form name="azuriraj" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=user&action=azurirajOglas">
       <input type="hidden" name="idOglasaZaAzuriranje" value="<?php echo $oglas->idO; ?>"/>      
                ...
                <div class='col-sm-12'>
                    <nav class='navbar navbar-expand-sm lightgraybg'>
                        <a class='navbar-brand' href='#'>
                            <img src='./views/PostaviOglasObican/slike/logo.png' id="logo">
                        </a>
                        ...
                        <table id="prva_tabela">
                            <tr>
                                <td><img src="./views/PostaviOglasObican/slike/ikon.PNG" alt=""></td>
                                <td><input type="text" value="<?php echo $_SESSION['user']->username ?>"></td>
                            </tr>
                            <tr>
                                <td id="td4" colspan="2">
                                    <a href="?controller=user&action=index"><img src="./views/PostaviOglasObican/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                                </td>
                            </tr>
                        </table>    
                    </nav>
