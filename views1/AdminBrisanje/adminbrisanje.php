...
<link rel='stylesheet' type='text/css' href='./views/AdminBrisanje/fajlovi/bootstrap.min.css'>
<link rel='stylesheet' type='text/css' href='./views/AdminBrisanje/adminbrisanje.css'>

<script src='./views/AdminBrisanje/fajlovi/bootstrap.min.js'></script>
<style>
    td {
  text-align: center;
}
...
<div class='container+fluid'>
        ...
        <div class='col-sm-12'>
            <nav class='navbar navbar-expand-sm lightgraybg'>
                <a class='navbar-brand button' href='#'>
                    <img src='./views/AdminBrisanje/slike/logo.png'>
                </a>
                ...
                <table id="prva_tabela">
                    ...
                    <tr>
                        <td><img src="./views/AdminBrisanje/slike/ikon.PNG" alt=""></td>
                        <td><input type="text" value="<?php echo $_SESSION['user']->username ?>"></td>
                    </tr>
                    <tr>
                        <td id="td4" colspan="2">
                            <a href="?controller=admin&action=index"><img src="./views/AdminBrisanje/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                        </td>
                    </tr>
    ...
    <br>
            ...
            <form name="clearform" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=admin&action=deleteAd">
    ...
    <table>
        <tr>
            <td>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Unesite ID oglasa koji brisete:<br>
                
            </td>
            <td>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input type="text" name="id" placeholder="Unesite ID oglasa..." value="<?php if(isset($id)) echo $id; ?>"/>
            </td>
        </tr>
        <tr>
            <td colspan="2">
