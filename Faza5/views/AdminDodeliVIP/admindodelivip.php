...
<link rel='stylesheet' type='text/css' href='admindodelivip.css'>
    ...
    <div class='row prvi_red'>
        <div class='col-sm-12'>
            <nav class='navbar navbar-expand-sm lightgraybg'>
                ...
                <!-- <ul class='navbar-nav'>
                    <li class='nav-item'>
                        <input type="button" class=' btn btn-light' value="Odjavi se">
                    </li> 
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    ...
                    <li class='nav-item'>
                        <input type="button" class=' btn btn-light' value="nazad">
                    </li> 
                    &nbsp;
                    &nbsp;
                    &nbsp;
    ...
    <div class='row'>
        ...
        <div class='col-sm-9 right'>
            ...
            <table class='table '>
                <form>
                <tr>
                <td>Unesite korisnicko ime za dodelu VIP statusa

                </td>
                &nbsp;
                &nbsp;
                <td>
                    <input type="text" name='Focused text with caret' placeholder="Unesite ID">
            ...
            <form>
                    ...
                    <input type='button' class=' btn btn-light' value="Dodeli">
