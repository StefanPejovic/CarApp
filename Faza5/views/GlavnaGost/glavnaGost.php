     ...
     <form name="pretraga" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class='col-sm-12'>
                    <nav class='navbar navbar-expand-sm lightgraybg'>
                       ...
                       <input type="hidden" name="controller" value="oglas"/>
                        <input type="hidden" name="akcija" value="pretraziOglas"/>
                        <div id="postaviOglas">
                            <h4>Registruj se</h4>
                        </div>
                        <div id="postaniVIP">
                        ...
                        <table id="prva_tabela">
                            ...
                            <tr>
                                <td id="td4" colspan="2">
                                    <img src="./views/GlavnaGost/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz">
                                </td>
                            </tr>
                        </table>    
                    </nav>
            ...
            <div class='row'>  
                <div class='col-sm-10 drugi_red'>
                    <div id="pretraga"><p>Pretraga vozila</p></div>
