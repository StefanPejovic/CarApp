...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='./views/GlavnaKorisnikObican/fajlovi/bootstrap.min.css'>
    <link rel='stylesheet' type='text/css' href='./views/GlavnaKorisnikObican/glavnaKorisnikObican.css'>

    <script src='./views/GlavnaKorisnikObican/fajlovi/bootstrap.min.js'></script>
    ...
    <div class='container+fluid'>
                ...
                <div class='col-sm-12'>
                    <nav class='navbar navbar-expand-sm lightgraybg'>
                        <a class='navbar-brand' href='#'>
                            <img src='./views/GlavnaKorisnikObican/slike/logo.png' id="logo">
                        </a>
                        ...
                        <table id="prva_tabela">
                            <tr>
                                <td><img src="./views/GlavnaKorisnikObican/slike/ikon.PNG" alt=""></td>
                                <td><input type="text" value="<?php echo $_SESSION['user']->username ?>" disabled></td>
                            </tr>
                            <tr>
                                <td id="td4" colspan="2">
                                    <a href="?controller=user$action=index"><img src="./views/GlavnaKorisnikObican/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                                </td>
                            </tr>
                        </table>    
                    </nav>
            ...
            <div class='row'>  
                <div class='col-sm-10 drugi_red'>
                    ...
                    <div class="row blank">                 
<form name="pretraga" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=user&action=searchAd">
                        <table>
                            <tr id="red_selekcija">
                                <td>
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    <button name="button_trazi" type="submit" style="text-align: center; height: 70px; width: 170px" class="button_trazi">
                                        <a href="?controller=user&action=searchAd" style="text-decoration: none"><h3>Trazi</h3></a>
                                    </button>
                                </td>
                            </tr>
                        </table>
                ...
                <div class="col-sm-2 third" style="background-color: #dddddd; ;">
