...
<link rel='stylesheet' type='text/css' href='./views/AdminOduzmiVip/fajlovi/bootstrap.min.css'>
<link rel='stylesheet' type='text/css' href='./views/AdminOduzmiVip/adminoduzmivip.css'>

<script src='./views/AdminOduzmiVip/fajlovi/bootstrap.min.js'></script>
<style>
    td {
  text-align: center;
}
        ...
        <div class='col-sm-12'>
            <nav class='navbar navbar-expand-sm lightgraybg'>
                <a class='navbar-brand button' href='#'>
                    <img src='./views/AdminOduzmiVip/slike/logo.png'>
                </a>
                ...
                <table id="prva_tabela">
                    <tr>
                        <td><img src="./views/AdminOduzmiVip/slike/ikon.PNG" alt=""></td>
                        <td><input type="text" value="<?php echo $_SESSION['user']->username ?>"></td>
                    </tr>
                    <tr>
                        <td id="td4" colspan="2">
                            <a href="?controller=admin&action=index"><img src="./views/AdminOduzmiVip/slike/nazz.PNG" style="height:40px; width:100px;" alt="naz"></a>
                        </td>
                    </tr>
                </table>
            </nav>
